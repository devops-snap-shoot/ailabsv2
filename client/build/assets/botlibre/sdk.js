...
function WebAvatar() {
	...
	this.createBox = function() {
		...
		this.baseRoot = this.enableShadowDOM ? box.attachShadow({mode: 'open'}) : document;
		var html = "<style>\n"
				+ "." + this.prefix + "avatarbox {" + boxShadow + "line-height:0; overflow:hidden;"/* "line-height:0; overflow:hidden; position:fixed;" */ + boxbarloc + ";z-index:152;margin:0px;" + border + " }\n"
				/* + "." + this.prefix + "avatarbox:hover { border:0px;border-style:solid;border-color:black; }\n" */
		...
		const body = document.getElementById(this.elementToSet)
