...
const addUserToOrg = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const {userId, orgId} = req.body
        const response = await organizationsService.addUserToOrg(userId, orgId)
...
export default { createOrg, addUserToOrg, getAllOrgs, updateOrganization, deleteOrganization, getMyOrgs }
